...
|----|----|----|----|----|----|
|PathParameter|hostId||true|string||
|BodyParameter|body||false|AgentBean||
...
|QueryParameter|actionType||false|enum (SERVING, SERVING_AND_NORMAL, FIRST_DEPLOY, FAILED_FIRST_DEPLOY)||
...
|Type|Name|Description|Required|Schema|Default|
|----|----|----|----|----|----|
|PathParameter|envId|Env Id|true|string||
