...
class SoxPropertyPathExtractorTest extends BasePathExtractorTest {
    private SoxPropertyPathExtractor sut;
    ...
    void setUp() {
        super.setUp();
        sut = new SoxPropertyPathExtractor();
    }
    ...
    void testExtractResource_1EnvName() throws ExtractionException {
        ...
        assertEquals(AuthZResource.Type.SOX_PROPERTY, resource.getType());
    }
