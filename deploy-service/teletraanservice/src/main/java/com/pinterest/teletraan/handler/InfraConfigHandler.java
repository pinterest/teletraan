...
public class InfraConfigHandler {
    ...
    // SecurityContext sc,
    public void test(String envName, String stageName, InfraBean infraBean) throws Exception {
        ...
        //                    clusterName);
        //            EnvironBean originEnvironBean = Utils.getEnvStage(environDAO, envName,
        // stageName);
        //            try {
        //                EnvironBean updateEnvironBean =
        //                        originEnvironBean; //
        // .toBuilder().cluster_name(clusterName).build();
        //                environmentHandler.updateEnvironment(sc, envName, stageName,
        // updateEnvironBean);
        ...
        //                        clusterName,
        //                        originEnvironBean);
        //                rodimusManager.createCluster(clusterName, envName, stageName,
        // rodimusCluster);
        //            } catch (Exception e) {
        //                environmentHandler.updateEnvironment(sc, envName, stageName,
        // originEnvironBean);
        ...
        //            }
        //        } else {
        //            // Update cluster: Other successful GET responses only; this is checked in the
        // client
        //
        //            LOG.info("Updating cluster: {}", clusterName);
        //            RodimusCluster updateRodimusCluster = rodimusCluster.toBuilder().build(); //
        // rod 0.0
        ...
        //                            .getConfigs()
        //                            .put("spiffe_id", responseConfig.get("spiffe_id")); // rod
        // 0.0.0
        //                }
        //                if (responseConfig.containsKey("nimbus_id")) {
        //                    updateRodimusCluster
        //                            .getConfigs()
        //                            .put("nimbus_id", responseConfig.get("nimbus_id")); // rod
        // 0.0.1
        //                }
        //            }
        ...
        //            //          try {
        //            //            rodimusManager.updateCluster( // rod 2, not implemented in
        // Teletraan
        //            //                    clusterName,
        //            //
        //            //
