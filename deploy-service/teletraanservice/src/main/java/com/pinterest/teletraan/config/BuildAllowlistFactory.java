...
public class BuildAllowlistFactory {
    @JsonProperty private List<String> validBuildURLs;
    @JsonProperty private List<String> trustedBuildURLs;
    @JsonProperty private List<String> soxBuildURLs;
    ...
    public List<String> getsoxBuildURLs() {
        return this.soxBuildURLs;
    }

    public void setsoxBuildURLs(List<String> urls) {
        this.soxBuildURLs = urls;
    }
}
