    ...
    public void filter(ContainerRequestContext context) throws IOException {
        if(!context.getMethod().equals("OPTIONS")) {
            ...
            try {
                ...
                LOG.info("Audit log. Details: {\"request method: \" + context.getMethod() + \"; request uri: \" + context.getUriInfo().getRequestUri() + \"; user name: \" + securityContext.getUserPrincipal().getName()}");
            } catch (Exception e) {
