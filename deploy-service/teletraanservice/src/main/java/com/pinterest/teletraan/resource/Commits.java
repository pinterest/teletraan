...
public class Commits {
     ...
     * specified size, whichever happens first; if size == 0, then will return the full list until
     * endSha if endSha == null, then will return up to size, max_size = 500 It is recommended to
     * call multiple times (pagination) with size < 30 to avoid timeout
     */
    @GET
    @Timed
    @ExceptionMetered
