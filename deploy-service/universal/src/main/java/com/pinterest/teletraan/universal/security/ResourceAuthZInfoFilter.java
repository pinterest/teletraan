...
/**
 * This filter adds the ResourceAuthZInfo annotation to the request context properties so that it can
 * be used by the AuthZResourceExtractor to extract the resource information.
 */
@Provider
