...
public class DBDAOTest {
  ...
  public void testDeploymentQueries() throws Exception {
    ...
    List<DeployBean> beans = deployDAO.getAcceptedDeploys("env-3", new Interval(0, Long.MAX_VALUE), 100);
  ...
  public void testEnvDAO() throws Exception {
    ...
    hostDAO
        .insertOrUpdate("host-2", "1.1.1.2", "id-123435", HostState.TERMINATING.toString(), groups);
  ...
  public void testHostDAO() throws Exception {
    ...
    hostDAO
        .insertOrUpdate("h-9", "9.9.9.9", "i-9", HostState.PENDING_TERMINATE.toString(), groups9);
