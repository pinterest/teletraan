...
public class KnoxKeyTest {
    ...
    private List<Integer> answerList; // 0-null 1-exception 2-terminated-array 3-ec2tag 4-latency
    ...
    public void setUp() throws Exception {
        ...
        testKey[2] = "ccc".getBytes(); // extra for retries
    ...
    public void thbcnOk() throws Exception {
        ...
        final ArrayList<Integer> cmpArray = new ArrayList<Integer>() {{ add(0); }};
    ...
    public void thbcnErrorOk() throws Exception {
        ...
        final ArrayList<Integer> cmpArray = new ArrayList<Integer>() 
            {{ add(1); add(0); }};
        Assert.assertArrayEquals( this.answerList.toArray(), cmpArray.toArray() );
    }
    ...
    public void thbcnErrorNoRefresh() throws Exception {
        ...
        final ArrayList<Integer> cmpArray = new ArrayList<Integer>() {{ add(1); }};
        Assert.assertArrayEquals( this.answerList.toArray(), cmpArray.toArray() );
    }
    ...
    public void thbcnErrorRefreshUnauthorized() throws Exception {
        ...
        Assert.assertTrue( exception.getMessage().contains("HTTP request to Rodimus API failed") );

        int retries = this.getRetries(this.rodimusManager);
        final ArrayList<Integer> cmpArray = new ArrayList<Integer>() 
        {{ 
            for( int i=1; i<=retries; i++ ){ add(1); }; 
        }};
        Assert.assertArrayEquals( this.answerList.toArray(), cmpArray.toArray() );
    }
    ...
    public void gthOk() throws Exception {
        ...
        final ArrayList<Integer> cmpArray = new ArrayList<Integer>() {{ add(2); }};
    ...
    public void gcilgpOk() throws Exception {
        ...
        final ArrayList<Integer> cmpArray = new ArrayList<Integer>() {{ add(4); }};
...
//                   token keeps renewing but none works           1234
//                     (do not try indefinitely)
//                   other exceptions pass thru
...
// ### HELPER METHODS ###
    ...
    private int getRetries(RodimusManager rodimusMngr) throws Exception {
        // Get how many retries will rodimusManager should do
        int RETRIES;
