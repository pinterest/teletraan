...
CREATE TABLE IF NOT EXISTS environs (
    ...
    notify_authors   TINYINT(1)       NOT NULL DEFAULT 0,
    watch_recipients VARCHAR(1024),
    metrics_config_id VARCHAR(22),
    alarm_config_id     VARCHAR(22),
    webhooks_config_id  VARCHAR(22),
    max_deploy_num      INT           NOT NULL DEFAULT 5000,
    max_deploy_day      INT           NOT NULL DEFAULT 365,
    ...
    override_policy     VARCHAR(32)   NOT NULL DEFAULT 'OVERRIDE',
    ...
    stage_type          VARCHAR(32)   NOT NULL DEFAULT 'DEFAULT',
    is_sox              TINYINT(1)    NOT NULL DEFAULT 0,
    PRIMARY KEY   (env_id),
    UNIQUE KEY sc_config_id (sc_config_id),
