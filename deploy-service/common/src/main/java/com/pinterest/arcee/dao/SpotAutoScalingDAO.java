...
public interface SpotAutoScalingDAO {
    ...
    void updateSpotAutoScalingGroup(String groupName, SpotAutoScalingBean spotAutoScalingBean) throws Exception;

    List<SpotAutoScalingBean> getAllSpotAutoScalingGroups() throws Exception;
}
