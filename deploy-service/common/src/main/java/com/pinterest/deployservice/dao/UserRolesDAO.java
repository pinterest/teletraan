...
public interface UserRolesDAO {
    ...
    void update(UserRolesBean bean, String userName, String resourceId, AuthZResource.Type resourceType) throws Exception;

    UserRolesBean getByNameAndResource(String userName, String resourceId, AuthZResource.Type resourceType) throws Exception;
