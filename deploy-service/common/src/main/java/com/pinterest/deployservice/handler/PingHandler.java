...
public class PingHandler {
    ...
    private static final String INFRA_LATENCY_TIMER_NAME = CUSTOM_NAME_PREFIX + "teletraan.%s.infra_latency";
    ...
    void emitInfraLatency(long currentTime, String hostId, String asg) {
        try {
            ...
            String timerName = String.format(INFRA_LATENCY_TIMER_NAME, asg);
