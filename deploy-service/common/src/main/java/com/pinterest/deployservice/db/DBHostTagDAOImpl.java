...
public class DBHostTagDAOImpl implements HostTagDAO {
    ...
    @Override
    public List<String> getAllPrerequisiteTagValuesByEnvIdAndTagName(String envId, String tagName, String tagValue) throws Exception {
        return new QueryRunner(dataSource).query(GET_PREREQUISITES_TAG_VALUES_BY_HOST_ID_AND_TAG_NAME,
            SingleResultSetHandlerFactory.<String>newListObjectHandler(), envId, tagName, tagValue);
    }
}
