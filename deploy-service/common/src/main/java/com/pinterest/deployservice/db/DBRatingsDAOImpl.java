...
public class DBRatingsDAOImpl implements RatingDAO {
    ...
    private static final String GET_RATINGS = "SELECT * FROM user_ratings ORDER BY timestamp DESC LIMIT ?,?";
    private static final String INSERT_RATING_TEMPLATE = "INSERT INTO user_ratings SET %s";
    private static final String GET_USER_RATINGS = "SELECT * FROM user_ratings where author=? ORDER BY timestamp";
