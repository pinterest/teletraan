/* eslint no-restricted-globals: ["off", "location", "history"] */
/* globals require, module, location, history  */
/* global location history */
// patched 1.8.3 version for the #! bugs
...
function Context(path, state) {
  ...
  var hashbangPos = path.indexOf('#!')
  if (hashbang && hashbangPos !== -1) {
    this.path = path.substr(hashbangPos + 2) || '/'
  } else {
