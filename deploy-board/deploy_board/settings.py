...
DISABLE_CREATE_ENV_PAGE = True if os.getenv("DISABLE_CREATE_ENV_PAGE", "false") == "true" else False
REDIRECT_CREATE_ENV_PAGE_URL = os.getenv("REDIRECT_CREATE_ENV_PAGE_URL", None)
