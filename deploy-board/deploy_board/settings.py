...
CONSOLE_PROJECT_URL_FORMAT = os.getenv("CONSOLE_PROJECT_URL_FORMAT", "OFF")
CONSOLE_PROJECT_DATA_URL_FORMAT = os.getenv("CONSOLE_PROJECT_DATA_URL_FORMAT", "OFF")
...
TELETRAAN_WARNING_MESSAGE_URL = os.getenv("TELETRAAN_WARNING_MESSAGE_URL", None)
TELETRAAN_WARNING_MESSAGE_TITLE = os.getenv("TELETRAAN_WARNING_MESSAGE_TITLE", None)
