...
def get_launch_config(request, group_name):
    try:
        ...
        appNames = baseimages_helper.get_image_names(request, 'AWS',  settings.DEFAULT_REGION)
...
def get_aws_settings(request):
    ...
    images = baseimages_helper.get_by_name(request, app_name, settings.DEFAULT_REGION)
