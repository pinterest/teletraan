...
urlpatterns = [
    ...
    # hotfixes
    url(r'^env/(?P<name>[a-zA-Z0-9\-_]+)/(?P<stage>[a-zA-Z0-9\-_]+)/hotfixes/$',
        hotfix_views.HotfixesView.as_view()),
    url(r'^env/(?P<name>[a-zA-Z0-9\-_]+)/(?P<stage>[a-zA-Z0-9\-_]+)/hotfix/'
        r'(?P<id>[a-zA-Z0-9\-_]+)',
        hotfix_views.get_hotfix),
    url(r'^env/(?P<name>[a-zA-Z0-9\-_]+)/(?P<stage>[a-zA-Z0-9\-_]+)/patch/$',
        hotfix_views.patch),
