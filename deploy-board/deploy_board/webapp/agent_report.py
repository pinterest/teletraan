...
def gen_report(
    request, env, progress, sortByStatus="false", deploy=None, build_info=None
):
    agentStats = []
    firstTimeAgentStats = []
    deployStats = {}
    ...
    return AgentReport(
        firstTimeAgentStats=firstTimeAgentStats,
