...
urlpatterns = [
    ...
    url(r'^env/(?P<name>[a-zA-Z0-9\-_]+)/(?P<stage>[a-zA-Z0-9\-_]+)/reset_deploys_on_hosts/$', env_views.reset_deploys_on_hosts),
    ...
    url(r'^env/(?P<name>[a-zA-Z0-9\-_]+)/(?P<stage>[a-zA-Z0-9\-_]+)/reset_deploys/(?P<host_id>[a-zA-Z0-9\-_]+)$', env_views.reset_all_deploys),    
