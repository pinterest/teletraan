...
urlpatterns = [
    ...
    url(r'^clouds/baseimages/(?P<provider>[a-zA-Z0-9\-_\.]+)/(?P<region>[a-zA-Z0-9\-_\.]+)/$',
        cluster_view.get_images_by_provider_and_region),
    url(r'^clouds/placements/(?P<provider>[a-zA-Z0-9\-_\.]+)/(?P<region>[a-zA-Z0-9\-_\.]+)/$',
        cluster_view.get_placements_by_provider_and_region),
    url(r'^clouds/securityzones/(?P<provider>[a-zA-Z0-9\-_\.]+)/(?P<region>[a-zA-Z0-9\-_\.]+)/$',
        cluster_view.get_security_zones_by_provider_and_region),
