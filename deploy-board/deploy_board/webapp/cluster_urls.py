...
urlpatterns = [
    ...
    url(r'^clouds/get_base_image_info/(?P<name>[a-zA-Z0-9\-_]+)/$', cluster_view.get_base_image_info),
    ...
    url(r'^env/(?P<name>[a-zA-Z0-9\-_]+)/(?P<stage>[a-zA-Z0-9\-_]+)/replacement/$', cluster_view.get_replacement_histories),
