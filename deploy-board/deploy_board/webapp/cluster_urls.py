...
urlpatterns = [
    ...
    url(r'^env/(?P<name>[a-zA-Z0-9\-_]+)/(?P<stage>[a-zA-Z0-9\-_]+)/start_replacement/$', cluster_view.start_cluster_replacement),
    ...
    url(r'^env/(?P<name>[a-zA-Z0-9\-_]+)/(?P<stage>[a-zA-Z0-9\-_]+)/cluster-replacements/$', cluster_view.gen_cluster_replacement_view),
