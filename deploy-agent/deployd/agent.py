...
class DeployAgent(object):
    ...
    def serve_build(self):
        ...
        while ping_status != PingStatus.PING_FAILED and
                self._response and
                self._response.opCode and
                self._response.opCode != OpCode.NOOP:
            try:
            ...
            ping_status = self.update_deploy_status(deploy_report)
