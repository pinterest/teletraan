...
class TestStatusFunction(tests.TestCase):
    def test_load_dump_file(self):
        ...
        status2.build_info = BuildInfo(commit='bcd', build_url='http://pinterest.com', build_id='234')
        ...
        self.assertEqual(envs['env1'].build_info.build_commit, envs2['env1'].build_info.build_commit)
