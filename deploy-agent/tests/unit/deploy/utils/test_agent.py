...
class TestAgentHelperFunctions(tests.FileTestCase):
    def test_builds_available_locally(self):
        ...
        self.assertEqual('fakebuild', helper.builds_available_locally(self.builds_dir, 'fakeenv')[0][0])
    ...
    def test_get_stale_builds(self):
        ...
        self.assertEqual(
            list(Helper.get_stale_builds([('abuild', time1), ('abuild2', time2), ('abuild3', time3)], 2)), ['abuild3']
        )
    ...
    def test_get_build_id(self):
        ...
        """
        self.assertEqual(
            Helper.get_build_id("cmp_test-r4TTZfrWQEmgyaYic8uU6w_8ef9007.tar.gz", "cmp_test")[1],
            "r4TTZfrWQEmgyaYic8uU6w_8ef9007",
        )
        self.assertEqual(
            Helper.get_build_id("cmp_test-r4TTZfrWQEmgyaYic8uU6w_8ef9007.zip", "cmp_test")[1],
            "r4TTZfrWQEmgyaYic8uU6w_8ef9007",
        )
