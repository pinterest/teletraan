...
from deployd.common.utils import ensure_dirs, check_prereqs, check_first_puppet_run_success

@mock.patch('deployd.common.utils.send_statsboard_metric', new=mock.Mock(return_value= None))
class TestCommonUtils(TestCase):
    ...
    @mock.patch('deployd.common.utils.load_puppet_summary', new=mock.Mock(return_value= {'events': {'failure': 0}}))
    @mock.patch('deployd.common.utils.get_puppet_exit_code', new=mock.Mock(return_value= 5))
    ...
    @mock.patch('deployd.common.utils.is_first_run', new=mock.Mock(return_value=True))
    @mock.patch('deployd.common.utils.load_puppet_summary', new=mock.Mock(return_value= {'events': {'failure': 0}}))
    @mock.patch('deployd.common.utils.get_puppet_exit_code', new=mock.Mock(return_value= 999))
    ...
    @mock.patch('deployd.common.utils.IS_PINTEREST', True)
    @mock.patch('deployd.common.utils.is_first_run', new=mock.Mock(return_value=True))
    @mock.patch('deployd.common.utils.load_puppet_summary', new=mock.Mock(return_value= {'events': {'failure': 3}}))
    @mock.patch('deployd.common.utils.get_puppet_exit_code', new=mock.Mock(return_value= 999))
    ...
    @mock.patch('deployd.common.utils.load_puppet_summary', new=mock.Mock(return_value= {'events': {'failure': 2}}))
    @mock.patch('deployd.common.utils.get_puppet_exit_code', new=mock.Mock(return_value= 999))
